...
//Keeps the user input on the page even after the page is refreshed
    var savedItem8 = localStorage.getItem('text8'); document.getElementById('8').value = saved8;
    var savedItem9 = localStorage.getItem('text9'); document.getElementById('9').value = saved9;
    var savedItem10 = localStorage.getItem('text10'); document.getElementById('10').value = saved10;
    var savedItem11 = localStorage.getItem('text11'); document.getElementById('11').value = saved11;
    var savedItem12 = localStorage.getItem('text12'); document.getElementById('12').value = saved12;
    var savedItem13 = localStorage.getItem('text13'); document.getElementById('13').value = saved13;
    var savedItem14 = localStorage.getItem('text14'); document.getElementById('14').value = saved14;
    var savedItem15 = localStorage.getItem('text15'); document.getElementById('15').value = saved15;
    var savedItem16 = localStorage.getItem('text16'); document.getElementById('16').value = saved16;
    var savedItem17 = localStorage.getItem('text17'); document.getElementById('17').value = saved17;
     });